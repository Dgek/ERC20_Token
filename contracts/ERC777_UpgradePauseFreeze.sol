...
// Based on: @openzeppelin/contracts-upgradeable/token/ERC777/ERC777Upgradeable.sol
...
// Additions to openzeppelin ERC777Upgradeable.sol
    ...
    PausableUpgradeable
{
    ...
    modifier whenNotPausedOrFrozen() {
        ...
        require(!isFrozen(_msgSender()), "Freezable: freezed");
        _;
    }
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override whenNotPausedOrFrozen returns (bool) {
        require(
            recipient != address(0),
            "ERC777: transfer to the zero address"
        );
